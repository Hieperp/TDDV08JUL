...
namespace TotalDAL.Helpers.SqlProgrammability.Purchases
{
    public class PurchaseRequisition
    {
        ...
        private void GetPurchaseRequisitionIndexes()
        {
            ...
            queryString = queryString + "       SELECT      PurchaseRequisitions.PurchaseRequisitionID, CAST(PurchaseRequisitions.EntryDate AS DATE) AS EntryDate, PurchaseRequisitions.Reference, PurchaseRequisitions.TrackingVouchers, Locations.Code AS LocationCode, Customers.Name AS CustomerName, ISNULL(VoidTypes.Name, CASE PurchaseRequisitions.InActivePartial WHEN 1 THEN N'Hủy một phần đh' ELSE N'' END) AS VoidTypeName, PurchaseRequisitions.Description, PurchaseRequisitions.TotalQuantity, PurchaseRequisitions.TotalQuantityAdvice, PurchaseRequisitions.Approved, PurchaseRequisitions.InActive, PurchaseRequisitions.InActivePartial " + "\r\n";
